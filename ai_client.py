        ...
        async with ClientSession(read, write) as session:
            ...
            while True:
                ...
                try:
                    ...
                    try:
                        drawing_params = json.loads(gemini_output)
                        tool_name = drawing_params.get("tool_name")
                        args = drawing_params.get("args", {})

                        # If Gemini doesn't recognize open_paint, check user command manually
                        if (tool_name is None or tool_name == "") and "open" in user_command.lower() and "paint" in user_command.lower():
